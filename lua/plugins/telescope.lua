return {
    ...
    config = function()
        ...
        keymap("n", "<leader>ff", "<cmd>Telescope find_files<cr>", { desc = "Find Files" })  -- fuzzy find files
        keymap("n", "<leader>fg", "<cmd>Telescope live_grep<cr>", { desc = "Live Grep" })    -- fuzzy live grep
        ...
        keymap("n", "<leader>fc", "<cmd>Telescope grep_string<cr>", { desc = "Grep String" })  -- grep string under cursor
